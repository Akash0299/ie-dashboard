                            ...
                            <li className="nav-item nav-profile">
                                <Dropdown>
                                    <Dropdown.Toggle className="nav-link">
                                        {authProvider.account ? authProvider.account.name : 'User'}  <img src={require("../../assets/face.jpg")} alt="user" className='img-fluid user-icons' />
                                    </Dropdown.Toggle>
                                    <Dropdown.Menu className="navbar-dropdown">
                                        <Dropdown.Item href="#">
                                        ...
                                        <Dropdown.Item href="#" onClick={authProvider.logout}>
